...
public class evenement {
    ...
    public evenement( String nom_event, String description_event, Timestamp date_debut_event, Timestamp date_fin_event, String lieu_event, double budget_event, int id_transport, String image) {
    ...
    public String toString() {
        return "evenement{" + "id_event=" + id_event + ", nom_event=" + nom_event + ", description_event=" + description_event + ", date_debut_event=" + date_debut_event + ", date_fin_event=" + date_fin_event + ", lieu_event=" + lieu_event + ", budget_event=" + budget_event + ", id_transport=" + id_transport + ", image=" + image + '}';
    }
